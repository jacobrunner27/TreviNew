...
import { View, Text, StyleSheet, Slider, TextInput, ScrollView, TouchableOpacity, FlatList, Image } from 'react-native';
...
class OffersTinder extends Component {
    constructor(props) {
        super(props);
        this.state = {
            products_list: [
    ...
    render() {
        const { detailed_product_index, products_list, selected_product_index } = this.state
        return (
